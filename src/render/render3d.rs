...
use mvutils::utils::{Death, TetrahedronOp};
...
pub(crate) struct DeferredPass {
    ...
    geom_pass: Option<Death<RenderPass>>,
    light_pass: Option<Death<RenderPass>>,
    projection: Mat4,
    view: Mat4,
    pass: usize,
    sibo: Buffer,
...
impl DeferredPass {
    ...
    fn begin_geom(&self, enc: &mut CommandEncoder) -> Death<RenderPass> {
    ...
    fn begin_light(&self, enc: &mut CommandEncoder, target: &TextureView) -> Death<RenderPass> {
