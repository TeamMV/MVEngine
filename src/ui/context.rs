...
use crate::game::timing::Scheduler;
...
pub struct InnerContext {
    //'static because this is a reference to the R struct generated by the r! macro which creates a static R: R
    pub resources: &'static dyn UiResources,
