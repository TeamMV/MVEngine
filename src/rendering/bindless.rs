...
pub static GetTextureHandleARB: CreateOnce<unsafe extern "C" fn(GLuint) -> GLuint64> =
    CreateOnce::new();
pub static GetTextureSamplerHandleARB: CreateOnce<
    unsafe extern "C" fn(GLuint, GLuint) -> GLuint64,
> = CreateOnce::new();
pub static MakeTextureHandleResidentARB: CreateOnce<unsafe extern "C" fn(GLuint64)> =
    CreateOnce::new();
pub static MakeTextureHandleNonResidentARB: CreateOnce<unsafe extern "C" fn(GLuint64)> =
    CreateOnce::new();
pub static GetImageHandleARB: CreateOnce<
    unsafe extern "C" fn(GLuint, GLint, GLboolean, GLint, GLenum) -> GLuint64,
> = CreateOnce::new();
pub static MakeImageHandleResidentARB: CreateOnce<unsafe extern "C" fn(GLuint64, GLenum)> =
    CreateOnce::new();
pub static MakeImageHandleNonResidentARB: CreateOnce<unsafe extern "C" fn(GLuint64)> =
    CreateOnce::new();
pub static IsTextureHandleResidentARB: CreateOnce<unsafe extern "C" fn(GLuint64) -> GLboolean> =
    CreateOnce::new();
pub static IsImageHandleResidentARB: CreateOnce<unsafe extern "C" fn(GLuint64) -> GLboolean> =
    CreateOnce::new();
pub static UniformHandleui64ARB: CreateOnce<unsafe extern "C" fn(GLint, GLuint64)> =
    CreateOnce::new();
pub static UniformHandleui64vARB: CreateOnce<
    unsafe extern "C" fn(GLint, GLsizei, *const GLuint64),
> = CreateOnce::new();
pub static ProgramUniformHandleui64ARB: CreateOnce<unsafe extern "C" fn(GLuint, GLint, GLuint64)> =
    CreateOnce::new();
pub static ProgramUniformHandleui64vARB: CreateOnce<
    unsafe extern "C" fn(GLuint, GLint, GLsizei, *const GLuint64),
> = CreateOnce::new();
...
pub unsafe fn load_bindless_texture_functions(handle: &glutin::Window) {
    ...
    MakeTextureHandleNonResidentARB
        .create(|| load_function(handle, "glMakeTextureHandleNonResidentARB"));
    ...
    MakeImageHandleNonResidentARB
        .create(|| load_function(handle, "glMakeImageHandleNonResidentARB"));
