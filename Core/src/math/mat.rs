...
impl Mat4 {
    ...
    pub fn orthographic(
        ...
        Self([
            inv_width + inv_width, 0.0, 0.0, 0.0,
            0.0, inv_height + inv_height, 0.0, 0.0,
            0.0, 0.0, inv_depth, 0.0,
            -(left + right) * inv_width, -(top + bottom) * inv_height, -inv_depth * near, 1.0
        ].into())
    }
    ...
    pub fn perspective(fov: f32, aspect_ratio: f32, near: f32, far: f32) -> Self {
        ...
        Self([
            fov_ratio, 0.0, 0.0, 0.0,
            0.0, fov_tan, 0.0, 0.0,
            0.0, 0.0, inv_depth, 0.0,
            0.0, 0.0, -inv_depth * near, 0.0
        ].into())
    }
}